...
- isEnable - позволяет включить/выклюсит группу
- default - устанавливает группу, как группу по умолчанию. Настройки этой группы будут применены ко всем игрокам, но могут быть перезаписаны настройками из группы с более высоким приоритетом или персональными настройками игрока.
- priotity - приоритет группы. Если пользователь является членом нескольких групп, то совпадающие настройки и разрешения из группы с более высоким приоритетом перезаписывают аналогичные настройки и разрешения групп с более низким приоритетом
- permissions - секция содержит разрешения для различных плагинов. смотрите примеры использования
- options - секция содержит параметры для различных плагинов. смотрите примеры использования
